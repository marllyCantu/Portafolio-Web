          ...
          <ul>
            ...
            <li> <img src="images/artists/Constance_Smith_tn.jpg" alt="Art in Unexpected Places">
              <div class="textinfo">
                ...
                <p>Drawing and painting flowers may seem like a first-year art student’s assignment, but Constance Smith brings depth, shadows, light, and color to new heights with his unique technique of painting on canvas with ceramic glaze. This session is sure to be a hit with mixed media buffs.<br><br></p>
              </div>
              <!-- textinfo --> 
            </li>
            <li> <img src="images/artists/Riley_Rewington_tn.jpg" alt="Art in Unexpected Places">
              <div class="textinfo">
                ...
                <p>Grab your pencils, charcoal, acrylics, watercolors, or whatever painting tools suit your fancy, and participate in the capturing of various still life settings that are staged all around Dennison Hall. You won’t believe the wealth and depth of choices.<br><br></p>
              </div>
              <!-- textinfo --> 
            </li>
          </ul>
