<footer>
    <div class="branding"> <img src="/roux_academy/roux_academy/images/ralogo_monogram.png" alt="Logo"> </div>
    ...
    <nav>
      <ol>
        <li><a href="http://rouxacademy.com/about/about.htm">About Roux Academy</a></li>
